...
- API version: 1.0.11
  - Build date: 2025-11-06T19:37:46.461415+01:00[Europe/Brussels]
...
------------ | ------------- | ------------- | -------------
*DoctorApi* | [**createDoctor**](docs/DoctorApi.md#createDoctor) | **POST** /api/v1/doctor | 
*DoctorApi* | [**getDoctors**](docs/DoctorApi.md#getDoctors) | **GET** /api/v1/doctor | Get all Doctors from the system


## Documentation for Models

 - [ApiDoctor](docs/ApiDoctor.md)
 - [ApiError](docs/ApiError.md)
 - [DoctorCreatedEvent](docs/DoctorCreatedEvent.md)
