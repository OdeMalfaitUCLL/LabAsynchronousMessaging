...
public class RabbitMqConfig {
    ...
    @Bean
    public Queue doctorNotificationQueue() {
        return new Queue("q.doctor-notification-service");
    }
    @Bean
    public Queue fallbackNotificationQueue() {
        return new Queue("q.fall-back-notification");
    }
